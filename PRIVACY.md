...
Plot Twist doesn't ask you to create an account, sign in, or provide an email address to use the app.

## What stays on your device

Everything you tell Plot Twist about yourself and your reading lives only in local storage on your own phone. This includes:
...
- Which theme you're using and other app settings

None of this is sent to us, sold, or shared with anyone. If you delete Plot Twist from your phone, it's gone — we don't have a copy anywhere.

Your birthday, if you add one, is used only to set an age-appropriate ceiling on how explicit a book's content rating can be, and to notice your birthday week for a small in-app touch. It's never transmitted anywhere.
...
Plot Twist is not directed at children under 13, and we don't knowingly collect information from children. The age-based content filter described above runs entirely on your device from a birthday you optionally provide — we never see it.
